...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect4Command
    {

        public static int Group = 4;

        public static AnsiString Name = new AnsiString("AttachEffect4");
        public static UniString UIName = new UniString("Attach Effects 4");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect4Command> pThis)
        {
