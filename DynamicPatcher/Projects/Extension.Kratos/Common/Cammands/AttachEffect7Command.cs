...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect7Command
    {

        public static int Group = 7;

        public static AnsiString Name = new AnsiString("AttachEffect7");
        public static UniString UIName = new UniString("Attach Effects 7");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect7Command> pThis)
        {
