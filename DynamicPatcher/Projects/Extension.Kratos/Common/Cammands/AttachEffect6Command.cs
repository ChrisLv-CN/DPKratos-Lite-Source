...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect6Command
    {

        public static int Group = 6;

        public static AnsiString Name = new AnsiString("AttachEffect6");
        public static UniString UIName = new UniString("Attach Effects 6");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect6Command> pThis)
        {
