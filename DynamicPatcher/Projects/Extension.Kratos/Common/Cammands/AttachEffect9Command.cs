...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect9Command
    {

        public static int Group = 9;

        public static AnsiString Name = new AnsiString("AttachEffect9");
        public static UniString UIName = new UniString("Attach Effects 9");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect9Command> pThis)
        {
