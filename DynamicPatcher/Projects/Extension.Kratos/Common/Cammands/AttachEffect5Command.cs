...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect5Command
    {

        public static int Group = 5;

        public static AnsiString Name = new AnsiString("AttachEffect5");
        public static UniString UIName = new UniString("Attach Effects 5");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect5Command> pThis)
        {
