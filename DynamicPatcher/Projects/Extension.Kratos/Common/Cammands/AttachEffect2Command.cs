...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect2Command
    {

        public static int Group = 2;

        public static AnsiString Name = new AnsiString("AttachEffect2");
        public static UniString UIName = new UniString("Attach Effects 2");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect2Command> pThis)
        {
