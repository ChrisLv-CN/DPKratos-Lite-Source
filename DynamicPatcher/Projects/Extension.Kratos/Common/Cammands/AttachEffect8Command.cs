...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect8Command
    {

        public static int Group = 8;

        public static AnsiString Name = new AnsiString("AttachEffect8");
        public static UniString UIName = new UniString("Attach Effects 8");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect8Command> pThis)
        {
