...
{
    // 按下快捷键给选定的单位附加AE
    public struct AttachEffect3Command
    {

        public static int Group = 3;

        public static AnsiString Name = new AnsiString("AttachEffect3");
        public static UniString UIName = new UniString("Attach Effects 3");
        ...
        public static unsafe void Constructor(Pointer<AttachEffect3Command> pThis)
        {
