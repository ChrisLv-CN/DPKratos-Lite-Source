...
namespace Extension.Ext
{
    ...
    public class PrintTextData
    {
        ...
        protected bool TryReadPrintText(INIReader reader, string section, string title)
        {
            ...
            // SHP设置
            bool useSHP = false;
            if (reader.Read(section, title + "UseSHP", ref useSHP))
            {
                isRead = true;
                this.UseSHP = useSHP;
            }
            ...
            if (reader.Read(section, title + "SHP", ref fileName))
            {
            ...
            int idx = 0;
            if (reader.Read(section, title + "ZeroFrameIndex", ref idx))
            {
                isRead = true;
            ...
            if (reader.Read(section, title + "NoNumbers", ref noNumbers))
            {
                isRead = true;
            ...
            if (reader.Read(section, title + "HIT.SHP", ref longTextSHP))
            {
            ...
            int longTextIndex = 0;
            if (reader.Read(section, title + "HIT.Index", ref longTextIndex))
            {
                isRead = true;
                this.HitIndex = longTextIndex;
            }

            if (reader.Read(section, title + "MISS.SHP", ref longTextSHP))
            {
                string file = longTextSHP;
            ...
            longTextIndex = 0;
            if (reader.Read(section, title + "MISS.Index", ref longTextIndex))
            {
                isRead = true;
                this.MissIndex = longTextIndex;
            }

            if (reader.Read(section, title + "CRIT.SHP", ref longTextSHP))
            {
                string file = longTextSHP;
            ...
            longTextIndex = 0;
            if (reader.Read(section, title + "CRIT.Index", ref longTextIndex))
            {
                isRead = true;
                this.CritIndex = longTextIndex;
            }

            if (reader.Read(section, title + "GLANCING.SHP", ref longTextSHP))
            {
                string file = longTextSHP;
            ...
            longTextIndex = 0;
            if (reader.Read(section, title + "GLANCING.Index", ref longTextIndex))
            {
                isRead = true;
                this.GlancingIndex = longTextIndex;
            }

            if (reader.Read(section, title + "BLOCK.SHP", ref longTextSHP))
            {
                string file = longTextSHP;
            ...
            longTextIndex = 0;
            if (reader.Read(section, title + "BLOCK.Index", ref longTextIndex))
            {
                isRead = true;
