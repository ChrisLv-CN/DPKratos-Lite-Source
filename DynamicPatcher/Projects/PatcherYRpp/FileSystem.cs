...
namespace PatcherYRpp
{
    public static class FileSystem
    {
        ...
        private static IntPtr ppBUILDINGZ_SHA = new IntPtr(0x89DDBC);
        ...
        public static ref Pointer<SHPStruct> BUILDINGZ_SHA => ref ppBUILDINGZ_SHA.Convert<Pointer<SHPStruct>>().Ref;

        private static IntPtr pTEMPERAT_PAL = new IntPtr(0x885780);
        private static IntPtr pISOx_PAL = new IntPtr(0xABBED0);
        private static IntPtr pGRFXTXT_PAL = new IntPtr(0xA8F790);

        public static Pointer<BytePalette> TEMPERAT_PAL => pTEMPERAT_PAL;
        public static Pointer<BytePalette> ISOx_PAL => pISOx_PAL;
